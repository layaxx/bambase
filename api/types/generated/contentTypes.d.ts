...
export interface ApiMensaMealMensaMeal extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: "Mensa meal"
    pluralName: "mensa-meals"
    singularName: "mensa-meal"
  }
  options: {
    draftAndPublish: false
  }
  attributes: {
    allergens: Schema.Attribute.Component<"mensa.allergens", true>
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<"oneToMany", "api::mensa-meal.mensa-meal"> &
      Schema.Attribute.Private
    location: Schema.Attribute.Enumeration<["Feki", "Erba", "Austra\u00DFe"]> &
      Schema.Attribute.Required
    name: Schema.Attribute.String & Schema.Attribute.Required
    priceOther: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >
    priceStaff: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0
        },
        number
      >
    priceStudents: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0
